...
if (!function_exists('resolveSpaPage')) {
    function resolveSpaPage(string $path): string
    {
        ...
        return match (true) {
            ...
            $path === 'dashboard' => 'Modules/Dashboard',
            $path === 'projects' => 'Modules/projects/Index',
            $path === 'projects/create' => 'Modules/projects/Create',
            preg_match('#^projects/\d+/edit$#', $path) === 1 => 'Modules/projects/Edit',
            preg_match('#^projects/\d+$#', $path) === 1 => 'Modules/projects/Show',
            $path === 'assessments' => 'Modules/Assessments/Index',
            $path === 'assessments/history' => 'Modules/Assessments/History',
            preg_match('#^assessments/\d+/review$#', $path) === 1 => 'Modules/Assessments/Review',
            $path === 'master/users' => 'Modules/Master/Users',
            $path === 'master/document-types' => 'Modules/Master/DocumentTypes',
            preg_match('#^exports/projects/\d+/certificate/preview$#', $path) === 1 => 'Modules/Exports/CertificatePreview',
