<template>
  <app-layout :user="user" :user-role="userRole" page-title="Dashboard Monitoring" :csrf-token="csrfToken">
    <!-- KPI Info Boxes -->
    <div class="row">
    ...
    <div class="card card-outline card-secondary shadow-sm">
      <div class="card-header border-0">
        ...
        <div class="card-tools">
          <a v-if="userRole === 'pemohon'" href="/projects/create" class="btn btn-success btn-sm">
            <i class="fas fa-plus mr-1"></i> Buat Permohonan Baru
          </a>
          <a v-if="userRole === 'penilai' || userRole === 'admin'" href="/assessments" class="btn btn-primary btn-sm">
          ...
          <tbody>
            <tr v-for="project in recentProjects" :key="project.id">
              ...
              <td class="text-center">
                <a v-if="userRole !== 'pemohon'" :href="`/assessments/${project.id}/review`" class="btn btn-primary btn-xs mr-1">
                  <i class="fas fa-search mr-1"></i> Review
                </a>
                <a :href="`/projects/${project.id}`" class="btn btn-info btn-xs">
