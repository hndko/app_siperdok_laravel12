<template>
  <app-layout :user="user" :user-role="userRole" page-title="Daftar Permohonan Saya" :csrf-token="csrfToken">
    <div class="card card-outline card-primary shadow-sm">
      <div class="card-header">
        ...
        <div class="card-tools">
          <a href="/projects/create" class="btn btn-success btn-sm font-weight-bold">
        ...
        <form method="GET" action="/projects" class="mb-4">
          <div class="row">
            <div class="col-md-4 mb-2">
              <input type="text" name="search" class="form-control" placeholder="Cari No. Permohonan / Judul..." :value="queryParams.search || ''">
            </div>
            <div class="col-md-3 mb-2">
              <select name="status" class="form-control" :value="queryParams.status || ''">
            ...
            <div class="col-md-3 mb-2">
              <select name="document_type_id" class="form-control" :value="queryParams.document_type_id || ''">
            ...
            <tbody>
              <tr v-for="prj in projects.data" :key="prj.id">
                ...
                <td class="text-center">
                  <a :href="`/projects/${prj.id}`" class="btn btn-info btn-xs mr-1"><i class="fas fa-eye"></i> Detail</a>
                  <a v-if="['draft', 'revision'].includes(prj.status)" :href="`/projects/${prj.id}/edit`" class="btn btn-warning btn-xs">
